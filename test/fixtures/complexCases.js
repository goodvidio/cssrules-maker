...
testWrap(
    ...
    `,
    [
        `module.insertRule('.a{content: " ";display: table;}');`,
        `module.insertRule('#b{color: red;}');`
    ].join('\n')
);
...
testWrap(
    ...
    `module.insertRule('.a#c.d .e::after, .f#c.d .e::after, .a#b.g .e::after, .a#c.g .e::after, .f#b.g .e::after, .f#c.g .e::after, .a#c.h .e::after, .f#c.h .e::after, #b .i::after, #c .i::after{clear: both;}');`
);
...
testWrap(
    ...
    `module.insertRule('.a#b.c .d, .e#b.c .d, .a#f.g .d, .a#b.g .d, .e#f.g .d, .e#b.g .d, .a#b.h .d, .e#b.h .d{list-style: none outside none;margin: 0;padding: 0;}');`
);
...
testWrap(
    ...
    `module.insertRule('.a#b.c .d>li, .f#b.c .d>li, .a#g.h .d>li, .a#b.h .d>li, .f#g.h .d>li, .f#b.h .d>li, .a#b.i .d>li, .f#b.i .d>li{display: inline-block;}');`
);

testWrap(
    'complex selector 6',
    `.a.b#c.d:nth-last-child(2),
...
testWrap(
    ...
    `module.insertRule('#a #b{-moz-box-sizing: border-box;box-sizing: border-box;position: relative;opacity: 0;height: 1rem;width: 100%;margin-top: 0.5rem;background: transparent;}');`
);
...
testWrap(
    ...
    `#a {
      ...
      perspective: 1000; }`,
    `module.insertRule('#a{opacity: 0.5;-webkit-transform: translate3d(0, 0, 0);transform: translate3d(0, 0, 0);-webkit-transition: all 0.15s;transition: all 0.15s;border-bottom: 3px solid transparent;-webkit-backface-visibility: hidden;backface-visibility: hidden;-webkit-perspective: 1000;perspective: 1000;}');`
);
